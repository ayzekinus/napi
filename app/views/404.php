        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    ...
                    <br/>
                    <br/>
                    <h1 class="error-text-2 bounceInDown animated"> Erişim Hatası</h1>
                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> Üzgünüz, bu sayfaya erişim için <u>yetkiniz</u> bulunmuyor.</strong></h2>
                    <br />
                    <p class="lead">
                        Sayfa erişiminde yetkili olduğunuzu ancak problem yaşadığınızı düşünüyorsanız lütfen <b>Sistem Yöneticisi</b> ile irtibata geçin..
                    </p>
