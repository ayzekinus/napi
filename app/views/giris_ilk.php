...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Url::base(); ?>assets/login/css/style.css?v=6">
    ...
    <style type="text/css">
        ...
        .cont {
            position: relative;
            height: 100%;
            background-image: url(<?php echo Url::base("assets/img/giris_bg/1.jpg");?>);
...
<div class="cont">
    ...
    <div class="container animated bounceInUp centerClass">

        <form id="formk" name="formk" class="">
            ...
            <div class="inputGroup inputGroup1">
                <label for="loginEmail" id="loginEmailLabel">Kullanıcı ID</label>
                <input type="text" id="loginEmail" name="username" maxlength="50" class="login" autocomplete="off"/>
                <p class="helper helper1">Kullanıcı ID</p>
            </div>
            <div class="inputGroup inputGroup2">
                <label for="loginPassword" id="loginPasswordLabel">Şifre</label>
                <input type="password" id="loginPassword" name="password" class="login" autocomplete="off"/>
            ...
            <div class="inputGroup inputGroup3">
                <button id="login" class="buttonGiris">Giriş Yap</button>
                <img src="<?php echo Url::base("assets/login/loading4.gif");?>" class="spinner"/>
                <p class="copy">Copyright © <?php echo date('Y');?> Celsus Data &nbsp;</p>
            </div>
...
<script src="<?php echo Url::base(); ?>assets/js/jquery-ui-1.10.4/js/jquery-ui-1.10.4.custom.min.js"></script>

<script  src="<?php echo Url::base(); ?>assets/login/js/index.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.login').keypress(function(e) {
            if (e.which == 13) {
                $(".buttonGiris").trigger("click");
                return false;
            }
        });

        $(document).on("click", ".buttonGiris", function(e) {

            $(".buttonGiris, .inputGroup1, .inputGroup2").hide();
            $(".spinner").show();
