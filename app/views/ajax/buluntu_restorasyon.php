                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" >
                            ...
                            <tr class="gelismis_arama">
                                ...
                                <th class="hasinput" style="width:200px">
                                    <input type="text" class="form-control column_filter" placeholder="Form" data-column="4" tabindex="4"/>
                                </th>


                                <th class="hasinput" style="width:250px">
                                    <input type="text" class="form-control column_filter" placeholder="Konservatör" data-column="5" tabindex="5"/>
                                </th>

                                <th class="hasinput" style="width:250px">
                                    <input type="text" class="form-control column_filter" placeholder="Bakanlık Temsilcisi" data-column="6" tabindex="6"/>
                                </th>

                                <th class="hasinput" style="width:350px">
                                    <input type="text" class="form-control column_filter" placeholder="Uygulayan" data-column="7" tabindex="7"/>
                                </th>
                            ...
                            <tr>
                                ...
                                <th data-class="expand" style="width: 430px;"> Bakanlık Temsilcisi</th>
                                <th data-class="expand" style="width: 430px;"> Uygulayan</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        dt.source = jsPath + 'index/buluntu_restorasyon_data';
        dt.table_name = 'restorasyon';
        dt.btn_edit = 'restorasyon_duzenle';
        dt.btn_detail = 'restorasyon_detay';
