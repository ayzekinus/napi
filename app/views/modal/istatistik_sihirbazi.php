        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-teal" id="wid-id-1" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2><strong>İstatistik</strong> <i>Sihirbazı</i></h2>
                        ...
                        <form id="formk" action="" class="smart-form">
                            ...
                            <div style="margin: 10px;">
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active">
                                        <a href="#s1" data-toggle="tab">İstatistik Sihirbazı </a>
                                    </li>
                                </ul>
                                ...
                                <div id="myTabContent1" class="tab-content padding-10">
                                    <div class="tab-pane fade active in" id="s1">
                                        ...
                                        <table class="table table-bordered table-striped table-condensed table-hover">
                                            ...
                                            <thead>
                                            <tr>
                                                <th colspan="4">İstatistik Kriterleri</th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td class="buluntu_select" style="width: 300px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;" colspan="3" >
                                                    ...
                                                    <div class="inline-group" style="float: left;padding-top: 5px;">
                                                        ...
                                                        <label class="radio" >
                                                            <input type="radio" name="grafik_tipi" value="pie" checked="checked">
                                                            <i></i>Pie</label>

                                                        <label class="radio">
                                                            <input type="radio" name="grafik_tipi" value="doughnut">
                                                            <i></i>Doughnut</label>


                                                        <label class="radio" >
                                                            <input type="radio" name="grafik_tipi" value="column">
                                                            <i></i>Column</label>

                                                        <label class="radio" >
                                                            <input type="radio" name="grafik_tipi" value="bar">
                                                            <i></i>Bar</label>

                                                    </div>


                                                    <div class="inline-group" style="float: left;padding-top: 5px;border-left: 1px solid #ddd;padding-left: 15px;">

                                                        <label class="radio">
                                                            <input type="radio" name="grafik_mod" value="3d" checked="checked">
                                                            <i></i>3D</label>

                                                        <label class="radio" >
                                                            <input type="radio" name="grafik_mod" value="2d" >
                                                            <i></i>2D</label>
