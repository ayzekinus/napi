        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-teal" id="wid-id-1" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2><strong>Yayın</strong> <i>Oluştur</i></h2>
                                    ...
                                    <div class="tab-pane fade active in" id="s1">
                                        ...
                                        <table class="table table-bordered table-striped table-condensed table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <label class="input">
                                                        <input name="eser_ad" type="text" placeholder="" class="required">
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 350px;">
                                                    <label class="input">
                                                        <input name="eser_yayinyeri" type="text" placeholder="">
                                                    </label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <label class="input" style="width: 100%; float: left;margin-right: 4%;">
                                                        <input name="eser_yazar" type="text" placeholder="" >
                                                    </label>
                                                </td>
                                                <td style="width: 150px;vertical-align:middle;">Yılı</td>
                                                <td>
                                                    <label class="input" style="width: 48%;float:left;">
                                                        <input name="eser_yil" type="text" placeholder="" class="mask_number">
                                                    </label>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="gorsel_thumb">
                                                    ...
                                                    <a href="index/yayin_yukle" data-target="#remoteModal"
                                                       data-toggle="modal"
