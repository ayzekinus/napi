<!--<link rel='stylesheet' href='<?php echo Url::base(); ?>assets/js/uploadify/uploadify.css'>-->
...
<!--<script src="<?php echo Url::base(); ?>assets/js/uploadify/jquery.uploadify.min.js?ver=3"></script>-->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        file.post_table = "acma_rapor_galeri";
            ...
            swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        var formdata = 'table=acma_rapor_galeri&dosya=' + alt;
